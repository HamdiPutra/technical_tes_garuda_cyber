...
8. Jalankan Migrasi php artisan migrate
9. Jalankan Laravel Server => php artisan serve
10. Buka terminal baru dan masuk ke folder nextjs : cd nextjs
11. Install dependency => npm install
12. Jalankan server nextjs : npm run dev
13. Buka website di : http://localhost:3000
